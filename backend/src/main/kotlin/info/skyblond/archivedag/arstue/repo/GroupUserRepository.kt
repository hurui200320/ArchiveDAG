...
interface GroupUserRepository : JpaRepository<GroupUserEntity, String> {
    ...
    fun findAllByUsernameOrderByGroupName(username: String, pageable: Pageable): Page<GroupUserEntity>

    fun findAllByGroupNameOrderByGroupName(groupName: String, pageable: Pageable): Page<GroupUserEntity>
}
